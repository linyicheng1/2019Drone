...
void USART3_IRQHandler(void)
{
	...
	float time = get_systick_ms() + get_systick_s()*1000 + get_systick_min()*60*1000;
...
//		{
	...
	//		DMA_ITConfig(DMA1_Channel3,DMA_IT_TC,ENABLE);
			...
			last_time = get_systick_ms() + get_systick_s()*1000 + get_systick_min()*60*1000;
//		}
